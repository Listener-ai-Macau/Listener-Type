...
#[cfg(not(target_os = "windows"))]
pub fn send_recording_control_speech_activity(_timeout: Duration) -> Result<(), String> {
    Err("Embedded BLE recognized speech activity is only supported on Windows".to_string())
}
