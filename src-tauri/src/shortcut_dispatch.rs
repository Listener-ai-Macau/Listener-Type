...
fn shortcut_primary(raw: &str) -> Result<enigo::Key, String> {
    ...
    let key = match upper.as_str() {
        ...
        #[cfg(not(target_os = "windows"))]
        "NUMPAD0" => enigo::Key::Unicode('0'),
        #[cfg(target_os = "windows")]
        "NUMPAD1" => enigo::Key::Numpad1,
        #[cfg(not(target_os = "windows"))]
        "NUMPAD1" => enigo::Key::Unicode('1'),
        #[cfg(target_os = "windows")]
        "NUMPAD2" => enigo::Key::Numpad2,
        #[cfg(not(target_os = "windows"))]
        "NUMPAD2" => enigo::Key::Unicode('2'),
        #[cfg(target_os = "windows")]
        "NUMPAD3" => enigo::Key::Numpad3,
        #[cfg(not(target_os = "windows"))]
        "NUMPAD3" => enigo::Key::Unicode('3'),
        #[cfg(target_os = "windows")]
        "NUMPAD4" => enigo::Key::Numpad4,
        #[cfg(not(target_os = "windows"))]
        "NUMPAD4" => enigo::Key::Unicode('4'),
        #[cfg(target_os = "windows")]
        "NUMPAD5" => enigo::Key::Numpad5,
        #[cfg(not(target_os = "windows"))]
        "NUMPAD5" => enigo::Key::Unicode('5'),
        #[cfg(target_os = "windows")]
        "NUMPAD6" => enigo::Key::Numpad6,
        #[cfg(not(target_os = "windows"))]
        "NUMPAD6" => enigo::Key::Unicode('6'),
        #[cfg(target_os = "windows")]
        "NUMPAD7" => enigo::Key::Numpad7,
        #[cfg(not(target_os = "windows"))]
        "NUMPAD7" => enigo::Key::Unicode('7'),
        #[cfg(target_os = "windows")]
        "NUMPAD8" => enigo::Key::Numpad8,
        #[cfg(not(target_os = "windows"))]
        "NUMPAD8" => enigo::Key::Unicode('8'),
        #[cfg(target_os = "windows")]
        "NUMPAD9" => enigo::Key::Numpad9,
        #[cfg(not(target_os = "windows"))]
        "NUMPAD9" => enigo::Key::Unicode('9'),
        #[cfg(target_os = "windows")]
