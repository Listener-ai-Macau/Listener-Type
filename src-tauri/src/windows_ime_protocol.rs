...
pub const LISTENER_TYPE_IME_PROTOCOL_VERSION: u32 = 1;
pub const LISTENER_TYPE_IME_PIPE_NAME_PREFIX: &str = r"\\.\pipe\ListenerTypeImeSubmit";

pub fn ime_pipe_name_for_target(process_id: u32, thread_id: u32) -> String {
    format!("{LISTENER_TYPE_IME_PIPE_NAME_PREFIX}-{process_id}-{thread_id}")
}
    ...
    I: IntoIterator<Item = String>,
{
    ...
    let process_pipe_prefix = format!("{LISTENER_TYPE_IME_PIPE_NAME_PREFIX}-{process_id}-");
...
mod tests {
    ...
    fn submit_text_roundtrips_as_camel_case_json() {
        let message = ImePipeMessage::SubmitText {
            ...
            text: "\u{4f60}\u{597d} Listener Type".to_string(),
    ...
    fn ime_pipe_name_includes_target_process_and_thread() {
        assert_eq!(
            ...
            r"\\.\pipe\ListenerTypeImeSubmit-1234-5678"
        );
    }
    ...
    fn ime_pipe_candidates_include_same_process_clients_after_exact_target() {
        let available = vec![
            ...
            r"\\.\pipe\ListenerTypeImeSubmit-4321-1111".to_string(),
            r"\\.\pipe\ListenerTypeImeSubmit-1234-9999".to_string(),
            r"\\.\pipe\ListenerTypeImeSubmit-1234-5678".to_string(),
            r"\\.\pipe\ListenerTypeImeSubmit-1234-bad".to_string(),
        ];
