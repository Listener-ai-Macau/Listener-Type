...
const FILE_BUDGETS = [
  ...
  { path: "coordinator/dictation_endpoint_clock.rs", maxLines: 400 },
  { path: "coordinator/dictation_preview.rs", maxLines: 1500 },
  { path: "coordinator/dictation_device_ai.rs", maxLines: 1200 },
  { path: "coordinator/dictation_wake_polish.rs", maxLines: 1700 },
  { path: "coordinator/dictation_wake_fusion.rs", maxLines: 100 },
  { path: "coordinator/dictation_session.rs", maxLines: 1200 },
  { path: "coordinator/dictation_embedded_submit.rs", maxLines: 1000 },
  { path: "coordinator/dictation_embedded_stream.rs", maxLines: 2400 },
  ...
  { path: "embedded_ble/windows_ble/pnp_cache.rs", maxLines: 800 },
  { path: "embedded_ble/windows_ble/recording_control.rs", maxLines: 600 },
  { path: "embedded_ble/windows_ble/capture_events.rs", maxLines: 1000 },
  ...
  { path: "embedded_ble/windows_ble/unpair.rs", maxLines: 1000 },
