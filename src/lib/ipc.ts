...
let mockSettings: UserPreferences = {
  ...
  deviceBatteryLowPowerEnabled: true,
...
function normalizeUserPreferences(prefs: UserPreferences): UserPreferences {
  ...
  return {
    ...
    deviceBatteryLowPowerEnabled: prefs.deviceBatteryLowPowerEnabled ?? true,
...
export function refreshDeviceSettingsStatus(): Promise<DeviceFirmwareSettingsStatus> {
  return invokeOrMock('refresh_device_settings_status', undefined, () => ({
    ...
    batteryLowPowerEnabled: mockSettings.deviceBatteryLowPowerEnabled,
  ...
  return invokeOrMock(
    ...
    () => {
      ...
      mockDeviceSettings = {
        ...
        batteryLowPowerEnabled: request.batteryLowPowerEnabled,
