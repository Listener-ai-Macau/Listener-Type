  ...
  settings: {
    ...
    recording: {
      ...
      embeddedBleRecovery: {
        ...
        reconnectingMessage: 'Listener Type 正在後台重連。請稍等片刻；如果沒有恢復，再點擊修復連接。',
        needsWakeKeyMessage: '裝置可能處於深度睡眠。請按 KEY4 或喚醒鍵，再重試 Listener BLE。',
        needsBluetoothMessage: '請打開 Windows 藍牙，確認 Listener 裝置已連接，然後重試。',
        needsRepairMessage: '請點擊「修復連接」。如果仍失敗，請重啟 Listener Type 並匯出診斷包。',
        needsRePairMessage: 'Windows 可能保留了舊的藍牙配對或 GATT 快取。請刪除 Listener 裝置後重新配對。',
        ...
        rePairSteps: '在 Windows 藍牙中刪除 Listener 裝置，重新配對，然後回到這裡刷新狀態。',
      },
