...
export const zhTW: typeof zhCN = {
  ...
  settings: {
    ...
    recording: {
      ...
      embeddedBleWizardDesc: '選擇 Listener BLE，在 Windows 藍牙中配對，然後完成一次硬體按鍵錄音檢查。',
      embeddedBleCheck: '檢查連接',
      embeddedBleOpenBluetooth: '打開 Windows 藍牙',
      embeddedBleConnectChecking: '正在查找已配對的 Listener 裝置，並打開 VKA1 音訊服務。',
      embeddedBleRecordChecking: '正在等待一次硬體按鍵錄音。按一次開始，說一句，再按一次結束。',
      embeddedBleProbeReady: '已完成一次硬體按鍵錄音，裝置健康可用。',
      embeddedBleStatusTitle: 'Listener BLE',
      embeddedBleSimpleDesc: '刷新後完成一次硬體按鍵錄音，確認裝置健康可用。',
      ...
      embeddedBleConnectionMessageChecking: '等待硬體按鍵錄音完成：按一次開始，說一句，再按一次結束。',
      embeddedBleConnectionReady: '已完成一次硬體按鍵錄音，裝置健康可用。',
      ...
      embeddedBleTimeout: '沒有等到一次完整的硬體按鍵錄音。請按一次開始，說一句，再按一次結束。',
      embeddedBleNotifyFailed: 'BLE 音訊連接初始化失敗。請重新連接裝置後再試。',
      embeddedBleGenericError: '硬體按鍵錄音檢查失敗。請重試，或先切到麥克風體驗。',
      embeddedBleRetry: '重試',
