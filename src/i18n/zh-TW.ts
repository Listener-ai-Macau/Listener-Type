...
export const zhTW: typeof zhCN = {
  ...
  settings: {
    ...
    recording: {
      ...
      embeddedBleWizardDesc: '選擇 Listener BLE，在 Windows 藍牙中配對，然後檢查連接和通知訂閱，再開始第一次錄音。',
      embeddedBleCheck: '檢查連接',
      embeddedBleOpenBluetooth: '打開 Windows 藍牙',
      embeddedBleConnectChecking: '正在查找已配對的 Listener 裝置，並打開 VKA1 音訊服務。',
      embeddedBleRecordChecking: '正在等待一段 BLE 音訊。請按一次裝置語音鍵。',
      embeddedBleProbeReady: '已找到裝置、連接成功，並完成 BLE 通知訂閱。按裝置語音鍵可繼續做真實錄音測試。',
      embeddedBleStatusTitle: 'Listener BLE',
      embeddedBleSimpleDesc: '刷新裝置狀態，確認裝置健康可用。',
      ...
      embeddedBleConnectionMessageChecking: '正在檢查裝置狀態。',
      embeddedBleConnectionReady: '裝置健康可用。',
      embeddedBleConnectionError: '連接異常',
      embeddedBleVoiceReady: '語音正常',
      embeddedBleHeartbeatLabel: '心跳',
      embeddedBleHeartbeatIdle: '未檢查',
      embeddedBleHeartbeatOk: '正常',
      embeddedBleHeartbeatChecking: '刷新中',
      embeddedBleHeartbeatMessageChecking: '正在檢查心跳包。',
      embeddedBleHeartbeatError: '異常',
      embeddedBleHeartbeatReady: '心跳正常，裝置已就緒。',
      ...
      embeddedBleTimeout: '等待裝置超時。裝置可能未按下語音鍵，或離電腦太遠。',
      embeddedBleNotifyFailed: 'BLE 通知訂閱失敗。請重新連接裝置後再試。',
      embeddedBleGenericError: '裝置測試失敗。請重試，或先切到麥克風體驗。',
      embeddedBleRetry: '重試',
