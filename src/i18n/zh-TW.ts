  ...
  overview: {
    ...
    deviceHealth: {
      ...
      reason: {
        ...
        needsWakeKey: '設備可能處於深度睡眠。請按 KEY4/喚醒鍵喚醒，再重試 Listener BLE。',
        lowPowerIdleDisconnect: 'Listener BLE 因低功耗空閒斷開，正在恢復連接。若設備已睡眠，請按 KEY4/喚醒鍵。',
  ...
  settings: {
    ...
    recording: {
      ...
      embeddedBleRecovery: {
        ...
        needsWakeKeyMessage: '裝置可能處於深度睡眠。請按 KEY4 或喚醒鍵，再重試 Listener BLE。',
    ...
    device: {
      ...
      errorBleName: '藍牙名稱必須是 1-32 個 ASCII 字元，且不能包含引號、分號、等號或反斜線。',
      powerPlugged: '插電',
      powerBattery: '電池',
      powerUnknown: '供電未知',
