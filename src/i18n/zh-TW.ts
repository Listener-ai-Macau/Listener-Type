...
export const zhTW: typeof zhCN = {
  ...
  settings: {
    ...
    device: {
      ...
      lowPowerManagementDesc: '插電和電池共用同一個進入低功耗等待時間；電池自動關機只在拔電後的電池模式生效。',
      pluggedLowPowerLabel: '插電自動進入低功耗',
      pluggedLowPowerDesc: '開啟後，USB / 充電 / 外部供電閒置也會進入設備低功耗；關閉後插電閒置保持喚醒。',
      batteryLowPowerLabel: '電池自動進入低功耗',
      batteryLowPowerDesc: '開啟後，拔電後的電池模式閒置會進入設備低功耗；關閉後電池模式保持喚醒直到自動關機。',
      lowPowerIdleLabel: '進入低功耗時間',
      lowPowerIdleDesc: '插電和電池模式共用這個等待時間，範圍 1-1440 分鐘。',
      autoShutdownLabel: '電池自動關機',
      autoShutdownDesc: '自動關機只在拔電後的電池模式生效；插電、充電或外部供電會阻止自動關機。',
      bleNameLabel: '藍牙名稱',
      bleNameDesc: '1-32 個 ASCII 字元；部分 Windows 裝置名稱變更需要重新連線或重新配對後才顯示。',
      minutes: '分鐘',
      errorBrightness: '亮度必須在 0-100 之間。',
      errorLowPowerIdle: '進入低功耗時間必須在 1-1440 分鐘之間。',
      ...
      pluggedLowPowerOn: '插電低功耗開',
      pluggedLowPowerOff: '插電低功耗關',
      batteryLowPowerOn: '電池低功耗開',
      batteryLowPowerOff: '電池低功耗關',
      sourceMock: '瀏覽器預覽模擬',
      sourceDefaults: '預設值',
