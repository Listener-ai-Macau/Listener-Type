...
export const en: typeof zhCN = {
  ...
  settings: {
    ...
    device: {
      ...
      pluggedAutoShutdownDesc: 'Off by default while plugged in. Use 0 to disable.',
      batteryAutoShutdownLabel: 'Auto-shutdown',
      batteryAutoShutdownDesc: 'Shuts down after long idle on battery power. Use 0 to disable.',
