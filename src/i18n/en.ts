...
export const en: typeof zhCN = {
  ...
  settings: {
    ...
    recording: {
      ...
      voiceprintDesc: 'Follow the two-step guide for about 14 seconds: say “{{phrase}}” three times naturally, then continue with at least 3 seconds of natural speech. Only OS-protected templates are saved; audio is discarded.',
      ...
      voiceprintGuideHint: 'No need to rush. Normal pauses will not end recording early; processing starts when the countdown ends.',
