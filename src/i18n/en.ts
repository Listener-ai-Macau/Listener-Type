...
export const en: typeof zhCN = {
  ...
  settings: {
    ...
    recording: {
      ...
      longFormDictationLabel: 'Long-form dictation',
      longFormDictationDesc: 'When on, auto-end waits about 2 seconds after you stop speaking—better for email or long notes. Off keeps the snappy 1-second end.',
      ...
      voiceAutoStopDesc: 'Ends about 1 second after you stop (other people do not extend it). Long-form mode uses about 2 seconds. Device silence detection also helps finish.',
      dictationPolishLabel: 'Transcript style',
      dictationPolishDesc: 'Faithful keeps your words; Clean lightly removes fillers and adds punctuation. Advanced packs live on the Style page.',
      dictationPolishRaw: 'Faithful',
      dictationPolishLight: 'Clean',
      dictationPolishStructured: 'Structured',
      dictationPolishFormal: 'Formal',
      voiceprintLabel: 'Only my voice can auto-start',
      voiceprintDesc: 'Say “{{phrase}}” three times naturally. Only an OS-protected template is saved; audio is discarded.',
      ...
      voiceprintCapturing: 'Say “{{phrase}}” 3 times',
