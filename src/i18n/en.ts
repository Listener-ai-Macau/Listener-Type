...
export const en: typeof zhCN = {
  ...
  settings: {
    ...
    device: {
      ...
      configDesc: 'Brightness is saved per power mode; auto-shutdown only applies after unplugging on battery.',
      ...
      lowPowerIdleLabel: 'Low-power wait',
      lowPowerIdleDesc: 'Minutes of inactivity before low-power idle. Range: 1-1440 minutes.',
      autoShutdownLabel: 'Battery auto-shutdown',
      autoShutdownDesc: 'Only applies on battery after long idle. USB, charging, or external power blocks automatic shutdown.',
