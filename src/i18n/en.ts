...
export const en: typeof zhCN = {
  ...
  settings: {
    ...
    recording: {
      ...
      voiceprintDesc: 'Follow four guided steps for about 15 seconds: say “{{phrase}}” in three separate samples, then continue with at least 3 seconds of natural speech. Only OS-protected templates are saved; audio is discarded.',
      ...
      voiceprintCapturing: 'Say “{{phrase}}” 3 times, then one natural sentence',
      ...
      voiceprintGuideFreeSpeech: 'Now speak one natural sentence for at least 3 seconds',
      voiceprintStepWake: 'Sample {{current}}/{{total}}: “{{phrase}}”',
      voiceprintStepFreeSpeech: 'Speak naturally for at least 3 seconds',
