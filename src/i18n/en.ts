...
export const en: typeof zhCN = {
  ...
  settings: {
    ...
    device: {
      ...
      bleNameDesc: '1-32 characters: letters, numbers, hyphen, or underscore. On Windows, name changes may require reconnecting or pairing again.',
      minutes: 'min',
      zeroMeansOff: '0 = off',
      ...
      errorBleName: 'Bluetooth name must be 1-32 characters using letters, numbers, hyphen, or underscore.',
