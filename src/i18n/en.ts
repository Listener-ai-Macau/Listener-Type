...
export const en: typeof zhCN = {
  ...
  settings: {
    ...
    device: {
      ...
      bleNameSavedNeedsPairing: 'Bluetooth name saved. The device will advertise again with the new name.',
      bleNamePairingTitle: 'Waiting to reconnect',
      bleNamePairingBody: 'The device will reappear as {{name}}. Reconnect when you see it.',
