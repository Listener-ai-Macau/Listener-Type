...
export const en: typeof zhCN = {
  ...
  settings: {
    ...
    device: {
      ...
      bleNameDesc: '1-29 printable ASCII characters. On Windows, name changes may require reconnecting or pairing again.',
      bleNameSavedNeedsPairing: 'Bluetooth name saved. Type cleaned old pairings; pair the device again in Windows Bluetooth.',
      bleNamePairingTitle: 'Pair again',
      bleNamePairingBody: 'Type tried to clean old pairings. Add {{name}} in Windows Bluetooth.',
      openBluetoothSettings: 'Open Windows Bluetooth',
      minutes: 'min',
      zeroMeansOff: '0 = off',
