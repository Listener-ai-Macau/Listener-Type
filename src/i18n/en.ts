...
export const en: typeof zhCN = {
  ...
  settings: {
    ...
    device: {
      ...
      pluggedLowPowerDesc: 'When on, USB, charging, or external-power idle may enter device low-power. When off, plugged idle stays awake; battery mode is unchanged.',
