...
export const en: typeof zhCN = {
  ...
  settings: {
    ...
    recording: {
      ...
      embeddedBleWizardDesc: 'Choose Listener BLE, pair in Windows Bluetooth, then complete one hardware-key recording check.',
      ...
      embeddedBleRecordChecking: 'Waiting for one hardware-key recording. Press once to start, speak, then press once to stop.',
      embeddedBleProbeReady: 'One hardware-key recording completed. Device healthy.',
      embeddedBleStatusTitle: 'Listener BLE',
      embeddedBleSimpleDesc: 'Refresh, then complete one hardware-key recording to confirm the device is healthy.',
      ...
      embeddedBleConnectionMessageChecking: 'Waiting for a hardware-key recording: press once to start, speak, then press once to stop.',
      embeddedBleConnectionReady: 'One hardware-key recording completed. Device healthy.',
      ...
      embeddedBleTimeout: 'No complete hardware-key recording arrived. Press once to start, speak, then press once to stop.',
      embeddedBleNotifyFailed: 'BLE audio connection setup failed. Reconnect the device and try again.',
      embeddedBleGenericError: 'Hardware-key recording check failed. Retry, or use the microphone for now.',
