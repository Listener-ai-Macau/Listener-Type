  ...
  settings: {
    ...
    shortcuts: {
      ...
      deviceKeys: {
        ...
        externalAppPlaceholder: 'App path, shortcut, or command',
        ...
        installedAppEmpty: 'No apps found; enter a path or command',
        installedAppManualHint: 'Using a manual path / command.',
