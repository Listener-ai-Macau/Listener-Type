...
export const en: typeof zhCN = {
  ...
  shell: {
    ...
    blePairingPrompt: {
      ...
      body: 'For the hardware voice key, connect the Listener device in Windows Bluetooth, then let Listener Type verify the BLE audio subscription. You can still use the microphone path.',
      later: 'Later',
  ...
  settings: {
    ...
    recording: {
      ...
      embeddedBleWizardDesc: 'Choose Listener BLE, pair in Windows Bluetooth, then verify connection and notification subscription before the first recording.',
      ...
      embeddedBleRecordChecking: 'Waiting for one BLE audio session. Press the device voice key once.',
      embeddedBleProbeReady: 'Device found, connected, and BLE notifications subscribed. Press the voice key to run a real recording test.',
      embeddedBleStatusTitle: 'Listener BLE',
      embeddedBleSimpleDesc: 'Refresh device status to confirm the device is healthy and usable.',
      ...
      embeddedBleConnectionMessageChecking: 'Checking device status.',
      embeddedBleConnectionReady: 'Device healthy and usable.',
      embeddedBleConnectionError: 'Connection issue',
      embeddedBleVoiceReady: 'Voice OK',
      embeddedBleHeartbeatLabel: 'Heartbeat',
      embeddedBleHeartbeatIdle: 'Not checked',
      embeddedBleHeartbeatOk: 'OK',
      embeddedBleHeartbeatChecking: 'Refreshing',
      embeddedBleHeartbeatMessageChecking: 'Checking heartbeat.',
      embeddedBleHeartbeatError: 'Error',
      embeddedBleHeartbeatReady: 'Heartbeat OK. Device is ready.',
      ...
      embeddedBleTimeout: 'Timed out waiting for the device. Press the voice key, or move the device closer.',
      embeddedBleNotifyFailed: 'BLE notification setup failed. Reconnect the device and try again.',
      embeddedBleGenericError: 'Device test failed. Retry, or use the microphone for now.',
