...
export const en: typeof zhCN = {
  ...
  settings: {
    ...
    recording: {
      ...
      copyFinalToClipboardLabel: 'Copy final text to clipboard',
      copyFinalToClipboardDesc: 'Keep the final text available for manual paste even when the cursor cannot be restored.',
      autoEnterSendLabel: 'Press Enter to send after completion',
      autoEnterSendDesc: 'Sends once only after you stop recording and the text is confirmed in the original input.',
