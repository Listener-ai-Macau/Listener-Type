...
export const en: typeof zhCN = {
  ...
  settings: {
    ...
    recording: {
      ...
      embeddedBleWizardDesc: 'Choose Listener BLE, pair in Windows Bluetooth, then check device status before the first recording.',
      ...
      embeddedBleProbeReady: 'Device found and healthy.',
