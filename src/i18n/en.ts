...
export const en: typeof zhCN = {
  ...
  settings: {
    ...
    recording: {
      ...
      voiceprintReadyDesc: 'Local voiceprint verification is active. Other speakers will not reach transcription.',
      voiceprintOpenGateDesc: 'No voiceprint: anyone who says the current wake phrase can start recording.',
