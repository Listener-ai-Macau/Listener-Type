...
export const en: typeof zhCN = {
  ...
  history: {
    ...
    submittedUnconfirmed: 'Sent, insertion unconfirmed',
  ...
  settings: {
    ...
    recording: {
      ...
      postActionsTitle: 'Recording automation',
      postActionsDesc: 'Choose automatic actions for recording and completed dictation.',
      voiceAutoStartLabel: 'Auto-start on voice',
      voiceAutoStartDesc: 'Listens for the wake phrase when the device is ready and the Bluetooth light is on. Noise alone will not start. In noisy rooms, speak closer and enroll a voiceprint.',
      voiceAutoStopLabel: 'Auto-end on silence',
      voiceAutoStopDesc: 'Ends about 1 second after you stop (other people do not extend it). Device silence detection also helps finish.',
      voiceprintLabel: 'Only my voice can auto-start',
      voiceprintDesc: 'Follow three guided samples for about 9 seconds, saying “{{phrase}}” naturally each time. Only OS-protected templates are saved; audio is discarded.',
      ...
      voiceprintGuidePreparing: 'Preparing the device…',
      voiceprintGuideProcessing: 'Recording complete. Creating the voiceprint locally…',
      voiceprintGuideWake: 'First, say “{{phrase}}” three times naturally',
      voiceprintGuideWakeStep: 'Sample {{current}}/{{total}}: say “{{phrase}}” naturally',
      voiceprintStepWake: 'Sample {{current}}/{{total}}: “{{phrase}}”',
      voiceprintGuideHint: 'Each step is sampled separately. Continue when the next step appears; normal pauses will not end recording early.',
      voiceprintWizardTitle: 'Teach Listener your voice',
      voiceprintWizardIntro: 'After enrollment, only your voice can wake recording and other speakers will not keep it open.',
      voiceprintWizardQuiet: 'Choose a reasonably quiet place',
      voiceprintWizardDistance: 'Speak naturally from your usual position',
      voiceprintWizardPrivacy: 'Audio is discarded after an on-device voiceprint is created',
      voiceprintWizardStart: 'Start enrollment',
      voiceprintWizardProgress: 'Step {{current}} of {{total}}',
      voiceprintWizardWakeStep: 'Say “{{phrase}}” — sample {{current}}',
      voiceprintWizardSayPhrase: 'Say “{{phrase}}”',
      voiceprintWizardDoNotClose: 'Almost done. Keep this window open.',
      voiceprintWizardPauseTip: 'Each step is about 3 seconds — speak as soon as it is your turn; the red dot marks the step being recorded',
      voiceprintWizardSuccessTitle: 'Voice enrollment complete',
      voiceprintWizardSuccessDesc: 'Your owner voiceprint is active. Listener will prioritize your voice and filter other speakers.',
      voiceprintWizardErrorTitle: 'That recording did not work',
      voiceprintWizardErrorTip: 'Move closer to the device, reduce background noise, and try again.',
      voiceprintWizardFeedback: {
        waiting: 'Start speaking when ready',
        hearing: 'Listening — finish naturally',
        good: 'Good. Pause and wait for the next step.',
        too_quiet: 'I could not hear that. Move closer and try again.',
        too_loud: 'That is too loud. Move back slightly.',
      },
      voiceprintRedo: 'Record again',
      voiceprintEnroll: 'Record voiceprint',
      voiceprintDelete: 'Delete',
      wakePhraseLabel: 'Wake phrase',
      wakePhraseDesc: 'Choose a Chinese wake phrase. Changing it requires recording your voiceprint again.',
      wakePhraseApply: 'Apply',
      wakePhraseApplying: 'Applying',
      removeFillerWordsLabel: 'Remove filler words',
      removeFillerWordsDesc: 'Remove standalone hesitation sounds from previews and final transcripts.',
      copyDictationToClipboardLabel: 'Keep transcript in clipboard',
      copyDictationToClipboardDesc: 'Keep each completed dictation ready to paste. This takes priority over clipboard restoration.',
      sendKeyAfterDictationLabel: 'Send after dictation',
      sendKeyAfterDictationDesc: 'Send a submit key after the transcript is inserted successfully.',
      postDictationKeyLabel: 'Submit key',
      postDictationKeyDesc: 'Choose the key used to submit the inserted transcript.',
    ...
    device: {
      ...
      configDesc: 'Low-power wait and auto-shutdown can be set separately for plugged and battery modes. Bluetooth name changes may require reconnecting.',
      ...
      writeToDevice: 'Write',
      writing: 'Writing',
      detailLastKnown: 'Settings were written. Readback is temporarily unavailable, so the UI shows the values just sent.',
      detailDefaults: 'The device is connected, but settings readback is temporarily unavailable. Defaults are shown.',
      detailUnavailable: 'Device is not connected. Connect it to read and write settings.',
      statusSourceLabel: 'Source',
      statusPowerLabel: 'Power',
      statusLowPowerLabel: 'Low power',
      statusWriteLabel: 'Write',
      pluggedModeTitle: 'Plugged mode',
      batteryModeTitle: 'Battery mode',
      powerTimingTitle: 'Power timing',
      powerTimingDesc: 'Low-power wait and auto-shutdown can be tuned separately for plugged and battery modes.',
      pluggedModeDesc: 'Used while on USB, charging, or external power.',
      batteryModeDesc: 'Used after unplugging. Low power turns lights off.',
      pluggedLowPowerEnabledLabel: 'Allow low power',
      pluggedLowPowerEnabledDesc: 'When off, plugged or charging mode keeps the active connection and light state.',
      pluggedLowPowerIdleLabel: 'Enter low power',
      pluggedLowPowerIdleDesc: 'Minutes of inactivity before low-power idle while plugged in, charging, or externally powered.',
      batteryLowPowerIdleLabel: 'Enter low power',
      batteryLowPowerIdleDesc: 'Minutes of inactivity before low-power idle and lights off after unplugging.',
      pluggedAutoShutdownLabel: 'Auto-shutdown',
      pluggedAutoShutdownDesc: 'Off by default while plugged in.',
      batteryAutoShutdownLabel: 'Auto-shutdown',
      batteryAutoShutdownDesc: 'Shuts down after long idle on battery power.',
      ledZoneTitle: 'Light brightness',
      ledZoneDesc: 'Limit maximum brightness per light zone, then write to sync the device.',
      ledZoneUnsupported: 'This firmware does not read back four-zone brightness yet. Update firmware to write it.',
      statusLedBrightnessLabel: 'Status lights',
      statusLedBrightnessDesc: 'PWR / BLE / REC / AI / OK / WARN',
      keyLedBrightnessLabel: 'Key lights',
      keyLedBrightnessDesc: 'KEY1-KEY4',
      knobLedBrightnessLabel: 'Knob light',
      knobLedBrightnessDesc: 'EC11 ring',
      edgeLedBrightnessLabel: 'Edge light',
      edgeLedBrightnessDesc: 'Frame accent light',
      identityTitle: 'Device identity',
      identityDesc: 'The name shown for this device in the system Bluetooth list.',
      bleNameLabel: 'Bluetooth name',
      bleNameDesc: '1-29 printable ASCII characters. Saved as the device Bluetooth advertising name.',
      minutes: 'min',
      zeroMeansOff: '0 = off',
      ...
      errorBleName: 'Bluetooth name must be 1-29 printable ASCII characters and cannot contain spaces, quotes, semicolons, equals signs, or backslashes.',
      ...
      writeHint: 'Click Write to sync changes to the device.',
      readOnlyHint: 'The current device state is read-only. Connect writable firmware to write settings.',
    },
    providers: {
      ...
      volcengineMappingNote: 'Secret Key is not required right now. Resource ID defaults to volc.seedasr.sauc.duration (Doubao Seed ASR 2.0 hourly plan).',
