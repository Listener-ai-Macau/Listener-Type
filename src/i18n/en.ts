...
export const en: typeof zhCN = {
  ...
  overview: {
    ...
    quickStartDemo: 'Open demo',
    quickStartDismiss: 'Dismiss',
    demoTitle: 'Offline demo',
    demoBadge: 'No config changes',
    demoDesc: 'No API key, network, or hardware yet? Preview the voice-to-expression path with a built-in sample.',
    demoInputLabel: 'Sample input',
    demoInput: 'I feel a little chased by the speed of the AI era today, but I am also curious whether it can help me explain my thoughts clearly.',
    demoOutputLabel: 'Sample output',
    demoOutput1: 'Today I feel pushed along by the pace of the AI era, but I am also curious: can it actually help me turn what is in my head into something clear?',
    demoOutput2: 'It feels like standing beside a fast conveyor belt: anxious, but still tempted to reach out and see if AI can turn scattered thoughts into words I can use.',
    demoOutput3: 'My feeling about AI is pressure mixed with curiosity. It changes quickly, but if it can help me express an idea clearly, I am willing to try once.',
    demoStyleLabel: 'Output style',
    demoFallbackLabel: 'Failure fallback',
    demoPlays: {
      anxiety: {
        title: 'AI anxiety riff',
        input: 'AI seems to update every day, like a train that never waits. I want to keep up, but I also do not want to be dragged by it.',
        output: 'AI feels like a fast train that never stops. Part of me wants to jump on and see the view; part of me worries I am only being pulled by the speed. Today, I can name the pressure and try one actually useful thing.',
        style: 'Half rant, half reflection: make AI-era pressure easier to say, keep curiosity and expression, and avoid therapy claims.',
        fallback: 'Without device, network, or API key, show this built-in sample. It is clearly marked as Demo, does not write config, and never pretends real recording succeeded.',
      },
      role: {
        title: 'Light character reply',
        input: 'Pretend you are a tiny desktop companion. I say today feels messy; answer with one easy sentence.',
        output: 'Got it. Today is not for sorting out the whole world. Let us clear one small corner of the desk and one small corner of the mind, starting with the easiest thing.',
        style: 'Light character line: warm, short, companion-like, but only for entertainment and expression, not a real relationship, toy, or professional advice.',
        fallback: 'Offline mode uses fixed character replies. On failure, offer another play, microphone test, or later cloud setup.',
      },
      polish: {
        title: 'Voice-to-expression polish',
        input: 'I want to tell the partner that this version should focus on the experience loop first, and we can confirm packaging and production details next round.',
        output: 'For this version, I suggest focusing first on the experience loop: getting users from launch and pairing to their first playable result. Packaging and production details can be reviewed together in the next round.',
        style: 'Turn spoken intent into clear sendable text: preserve meaning, do not invent facts, and do not treat Demo output as production output.',
        fallback: 'When cloud polish is unavailable, show the built-in sample result and note that real voice conversion still needs a working recording path or local ASR.',
      },
    },
    demoConfigNote: 'Demo uses built-in samples only. It does not save API keys, switch models, or hide real recording failures.',
    demoRegenerate: 'Try another',
  },
  history: {
    kicker: 'HISTORY',
    title: 'History',
  ...
  settings: {
    ...
    recording: {
      ...
      embeddedBleRecovery: {
        ...
        reconnectingMessage: 'Listener Type is reconnecting in the background. Wait a moment, then run Repair connection if it does not recover.',
        ...
        needsRepairMessage: 'Run Repair connection. If it still fails, restart Listener Type and export diagnostics.',
        needsRePairMessage: 'Windows may have a stale Bluetooth pairing or GATT cache. Remove the Listener device, then pair it again.',
        ...
        rePairSteps: 'In Windows Bluetooth, remove the Listener device, pair it again, then return here and refresh.',
      },
  ...
  modal: {
    ...
    about: {
      ...
      exportDiagnosticPackageDesc: 'Save a minimal diagnostic JSON with versions, BLE state, config state, and recent errors. It excludes audio, transcripts, and API keys.',
      exportDiagnosticPackageBtn: 'Export',
      deviceRecovery: 'Device recovery',
      deviceRecoveryDesc: 'No terminal or SDK required: stop the current recording/BLE session, open Windows Bluetooth, remove listener, then return to Recording -> Listener BLE and pair again. Export diagnostics if recovery still fails.',
      openBluetoothSettings: 'Start recovery',
      exporting: 'Exporting…',
      exportSuccess: 'Saved',
