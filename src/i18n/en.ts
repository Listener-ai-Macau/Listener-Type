  ...
  overview: {
    ...
    deviceHealth: {
      ...
      reason: {
        ...
        needsWakeKey: 'The device may be in deep sleep. Press KEY4 or the wake key, then retry Listener BLE.',
        lowPowerIdleDisconnect: 'Listener BLE entered low-power idle disconnect and is reconnecting. Press KEY4 or the wake key if the device is asleep.',
  ...
  settings: {
    ...
    recording: {
      ...
      embeddedBleRecovery: {
        ...
        needsWakeKeyMessage: 'The device may be asleep. Press KEY4 or the wake key, then retry Listener BLE.',
