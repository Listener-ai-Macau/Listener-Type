...
const HELP_URL = 'https://github.com/Listener-ai-Macau/Listener-Type#readme';
const RELEASE_NOTES_URL = 'https://github.com/Listener-ai-Macau/Listener-Type/releases';
    ...
    <div
      ...
      <div
        ...
        <div style={{ flex: 1, minWidth: 0, overflow: 'hidden', position: 'relative', display: 'flex', flexDirection: 'column' }}>
          ...
          <h2 style={{ margin: 0, padding: '22px 28px 8px', fontSize: 22, fontWeight: 600, letterSpacing: 0, flexShrink: 0 }}>{t(`modal.sections.${section}`)}</h2>
  ...
  return (
    <div>
      <div style={{ display: 'flex', alignItems: 'center', gap: 14, marginBottom: 16 }}>
        ...
        <div>
          <div style={{ fontSize: 17, fontWeight: 600 }}>Listener Type</div>
      ...
      <Row label={t('modal.about.source')}>
        <button
          style={btnGhost}
          onClick={() => openExternal('https://github.com/Listener-ai-Macau/Listener-Type')}
        >
          GitHub
        </button>
      </Row>
      <Row label={t('modal.about.docs')}>
        <button
          style={btnGhost}
          onClick={() => openExternal('https://github.com/Listener-ai-Macau/Listener-Type#readme')}
        >
      ...
      <Row label={t('modal.about.feedback')}>
        <button
          style={btnGhost}
          onClick={() => openExternal('https://github.com/Listener-ai-Macau/Listener-Type/issues')}
        >
