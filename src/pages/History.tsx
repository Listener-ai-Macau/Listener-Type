...
// 真实数据来自 ~/Library/Application Support/Listener Type/history.json。
...
export function History() {
  ...
  const onExportAudio = async () => {
    ...
    try {
      ...
      a.href = url;
      a.download = `listener-type-recording-${item.id}.wav`;
            ...
            {!loadError && filtered.map(s => (
              <button
                ...
                style={{
                  ...
                  background: selectedId === s.id ? 'rgba(101,123,112,0.06)' : 'transparent',
