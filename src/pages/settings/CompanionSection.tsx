...
function CompanionBringupCard() {
  ...
  const commands = [
    ...
    },
    {
      ...
      value: 'pwsh -NoProfile -File <ai-collaboration-workflow>\\scripts\\aiw.ps1 with-lock -Resource Companion-WB55,BLE-Companion -Purpose "Companion hardware acceptance" -Run pwsh -NoProfile -File .\\tools\\verify_companion_hardware_acceptance.ps1 -Execute -WorkflowLockHeld -PackagePath <companion-package.zip> -EvidencePath <companion_ui_screenshot_or_log>',
    },
    {
      id: 'flash',
    ...
    },
    {
      ...
      value: 'pwsh -NoProfile -File <ai-collaboration-workflow>\\scripts\\aiw.ps1 with-lock -Resource Companion-WB55 -Purpose "Companion wired factory flash validation" -Run pwsh -NoProfile -File .\\tools\\verify_companion_wired_flash.ps1 -Execute -WorkflowLockHeld -PackagePath <companion-package.zip>',
    },
    {
      id: 'capture',
