...
- Public Windows artifacts must be Authenticode-signed. Unsigned artifacts are internal-test only and must be published with SHA256 hashes plus an explicit SmartScreen/unknown-publisher warning.
