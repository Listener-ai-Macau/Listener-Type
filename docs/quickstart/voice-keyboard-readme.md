...
| 操作 | 功能 |
|---|---|
| 按下 KEY3 | 默认开始或停止语音录音，可在设备自定义键里调整 |
| 按下 EC11 旋钮 | 开机后执行 EC11 单击自定义动作，默认切换风格 |
...
| 设备连上但录音没反应 | 确认 KEY3 的单击动作仍配置为开始/停止录音 |
...
| 状态 | 用户含义 | 恢复口径 |
|---|---|---|
| Ready | 可以开始录音 | 按 KEY3 开始 |
| Recording | 正在听你说话 | 说完再按 KEY3 停止 |
